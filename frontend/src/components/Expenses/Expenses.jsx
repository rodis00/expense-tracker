...
import { faArrowUp, faShirt, faBriefcase,faEye } from "@fortawesome/free-solid-svg-icons";
...
const Expenses = () => {
  ...
  return (
    <main className="w-full min-h-screen flex flex-col items-center text-white">
      ...
      <DataPointsSelection handleSelection={handleDataPointsSelection} selectedPoints={chartPoints}/>
      <BarChart selectedPoints={chartPoints} name={'expenses'}/>
