          ...
          <ul className="w-full lg:w-[85%] flex flex-col xsm:flex-row justify-center items-center md:gap-8 ">
            <li className="w-[90%] xsm:w-1/3 lg:w-1/3 xsm:h-36 h-20 xlg:h-24 bg-thirdColor shadow-lg shadow-neutral-0 lg:shadow-neutral-800 mt-4 xsm:mt-0">
              <div className="w-full h-full flex xsm:flex-col xlg:flex-row items-center">
                <div className="w-14 h-14 mx-4 border-2 border-yellow-500 flex justify-center items-center xsm:mt-4 xlg:mt-0">
                  <FontAwesomeIcon icon={faArrowTrendUp} className="text-2xl" />
                </div>
                <div className="grow xsm:text-center xlg:text-left">
                  <h2 className="text-neutral-600 text-lg xlg:text-xl mt-2 xlg:mt-0">
                    Available Balance
                  </h2>
                  <span className="text-xl xlg:text-2xl">{balance}</span>
                </div>
              </div>
            </li>
            <li className="w-[90%] xsm:w-1/3 lg:w-1/3 xsm:h-36 h-20 xlg:h-24 bg-thirdColor shadow-lg shadow-neutral-0 lg:shadow-neutral-800 mt-4 xsm:mt-0">
              <div className="w-full h-full flex xsm:flex-col xlg:flex-row items-center">
                <div className="w-14 h-14 mx-4 border-2 border-secondColor flex justify-center items-center xsm:mt-4 xlg:mt-0">
                  <FontAwesomeIcon icon={faArrowTrendUp} className="text-2xl" />
                </div>
                <div className="grow xsm:text-center xlg:text-left">
                  <h2 className="text-neutral-600 text-lg xlg:text-xl mt-2 xlg:mt-0">
                  ...
                  <span className="text-xl xlg:text-2xl">{incomes}</span>
                </div>
              </div>
            </li>
            <li className="w-[90%] xsm:w-1/3 lg:w-1/3 xsm:h-36 h-20 xlg:h-24 bg-thirdColor shadow-lg shadow-neutral-0 lg:shadow-neutral-800 mt-4 xsm:mt-0">
              <div className="w-full h-full flex xsm:flex-col xlg:flex-row items-center">
                <div className="w-14 h-14 mx-4 border-2 border-red-400 flex justify-center items-center xsm:mt-4 xlg:mt-0">
                  <FontAwesomeIcon
                ...
                <div className="grow xsm:text-center xlg:text-left">
                  ...
                  <span className="text-xl xlg:text-2xl">{expenses}</span>
                </div>
              </div>
            </li>
          </ul>
